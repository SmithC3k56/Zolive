...
namespace zolive_model.Models.Home
{
    public class Brsl
    {
        public int code { get; set; }
        public string msg { get; set; }
        public GetConfig info { get; set; }
    }
    public class GetConfig
    {
        ...
        public List<string> live_time_coin { get; set; }
        ...
        public List<object> share_type { get; set; }
        public List<List<string>> live_type { get; set; }
        public List<Liveclass> liveclass { get; set; }
        public List<Videoclass> videoclass { get; set; }
        public List<Level> level { get; set; }
        public List<Levelanchor> levelanchor { get; set; }
        ...
        public List<string> sensitive_words { get; set; }
    ...
    public class Guide
    {
        ...
        public List<ImgLink> list { get; set; }
    }
